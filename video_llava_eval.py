...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default="video_llava", help="Model architecture to be used", choices=['video_llava'])
    parser.add_argument('--test', type=str, default="ag_iden", help="test name", choices=['ivat', 'control_t2v' ,'control_v2t', 'ag_iden','ag_bind','action_bind','action_mod','action_adv','coref','sequence'])
